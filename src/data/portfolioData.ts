...
export const FEATURED_GATEWAYS: FeaturedGateway[] = [
  ...
  },
  {
    ...
    subtitle: 'Broadcast, Motion & Commercial Production',
...
export const SHOWREEL_VIDEO: VideoItem = {
  ...
  role: 'Senior Motion Designer & Lead Animator',
  context: '15+ Years UAE Agency & Commercial Compilation',
  recognitions: 'Broadcast TVC Master • 4K 60FPS Master',
  year: '2025',
  description:
    'Comprehensive showcase demonstrating high-end broadcast commercials, kinetic typography, motion graphics, and visual momentum.',
  thumbnail:
...
export const AI_IDEATION_VIDEOS: VideoItem[] = [
  {
    ...
    role: 'Motion Designer & AI Technologist',
  ...
  },
  {
    ...
    role: 'Senior Motion Designer & Animator',
  ...
  },
  {
    ...
    category: 'Commercial TVC',
    role: 'Lead Compositor & 3D Designer',
  ...
  },
  {
    ...
    category: 'Commercial TVC',
    role: 'Senior Motion Designer & Compositor',
...
export const UGC_ADS_VIDEOS: VideoItem[] = [
  {
    ...
    role: 'Vertical Video Designer & Editor',
  ...
  },
  {
    ...
    role: 'Motion Editor & 3D Designer',
