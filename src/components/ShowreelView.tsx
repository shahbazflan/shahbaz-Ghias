      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-neutral-800/80">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-neutral-900 border border-neutral-800 text-xs font-mono text-neutral-300 hover:text-white hover:border-neutral-700 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
        ...
        <div className="p-7 rounded-2xl bg-neutral-900/60 border border-neutral-800 space-y-3">
          <div className="flex items-center gap-2 text-[#d85d3a]">
            ...
            <h3 className="font-syne text-base font-bold uppercase tracking-wide text-white">
              Creative Direction
            </h3>
          </div>
          ...
          <ul className="text-xs text-neutral-400 space-y-1.5 pt-2 border-t border-neutral-800/80 font-mono">
        ...
        <div className="p-7 rounded-2xl bg-neutral-900/60 border border-neutral-800 space-y-3">
          ...
          <div className="flex flex-wrap gap-1.5 pt-2 font-mono">
            {['After Effects', 'Premiere Pro', 'DaVinci Resolve', 'Veo 3', 'Midjourney', 'Runway Gen-3', 'Kling AI'].map((tool, idx) => (
              <span
                key={idx}
                className="px-2.5 py-1 rounded-lg text-xs font-medium bg-neutral-800 text-neutral-300 border border-neutral-700/60"
              >
                {tool}
              </span>
            ))}
        ...
        <div className="p-7 rounded-2xl bg-gradient-to-br from-neutral-900 via-neutral-900 to-[#d85d3a]/10 border border-neutral-800 flex flex-col justify-between space-y-4">
          <div>
            <span className="text-xs font-mono font-bold uppercase tracking-widest text-[#d85d3a] block mb-1">
              Available For Work
            </span>
          ...
          <div className="space-y-2 pt-2">
            <a
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-xs font-bold text-white bg-[#d85d3a] hover:bg-[#c24e2d] transition-colors shadow-lg shadow-[#d85d3a]/20"
            >
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-xs font-medium text-neutral-300 bg-neutral-800 hover:bg-neutral-700 transition-colors"
            >
